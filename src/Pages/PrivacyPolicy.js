...
function PrivacyPolicy() {
  return (
    ...
    <div className='Policywrap'>
      ...
      <p>
        At BlogWiki, accessible from https://blogwiki.in/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by BlogWiki
        ...
        shared and/or collect in BlogWiki. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>
        BlogWiki follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, BlogWiki uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        their visit to https://www.blogwiki.in/ and other sites on the internet. However,
      ...
      <a className='linkpolicy' href="https://policies.google.com/technologies/ads">
        https://policies.google.com/technologies/ads
      </a>
      <h2>Advertising Partners Privacy Policies</h2>
      <p>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of BlogWiki.
        <br />
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on BlogWiki, which are sent
        directly to users' browser. They automatically receive your IP address
        when this occurs. These technologies are used to measure the
        effectiveness of their advertising campaigns and/or to personalize the
        advertising content that you see on websites that you visit.
        <br />
        <b>Note:</b> that BlogWiki has no access to or control over these cookies
        that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>
      <p>
        BlogWiki's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity.<br></br>
        BlogWiki does not knowingly collect any Personal Identifiable
